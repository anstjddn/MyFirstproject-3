...
//만능은 아니고 솔루션이라서 내가 수정하면서 사용하면된다.
...
/*
	...
	3. 생성자의 접근권한을 외부에서 생성할 수 없도록 제한(private로만들어서 외부에서 접근하지못하게)
	4. Instance 속성를 통해 인스턴스에 접근할 수 있도록 함
	5. instance 변수는 단 하나만 있도록 유지
	장점 :														// 외부에서 생성 불가능 처음시작할때 한번생성하여 계속유지
	...
	3. 싱글톤의 데이터를 공유할 경우 데이터 변조에 주의해야함  ex)골드 얻고 쓸때 순서대로 잘해라 따라서 대입하지말고 증감으로 표시
															  해라
*/

//ex) 플레이어의 골드, 인벤토리,퀘스트에 사용
